...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    //60s*60min*12h (milliseconds)
    private static final int SYNC_INTERVAL = 60 * 60 * 12;
    private static final int SYNC_FLEXTIME = SYNC_INTERVAL/3 ;

    //Projection for notification info
    ...
    private static final long DAY_IN_MILLS = 1000*60*60*12;
...
//    }
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            final String APPID = "f005d9fd85a06dac956bb507ccb64d07";
    ...
    private static void onAccountCreated(Account newAccount, Context context){
        //Since we have created an account
    ...
    private void notifyWeather() {
        ...
        //Checking the last update and notify if it's the first time
        ...
        if(displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLS) {
                //last sync was more than 1 day ago,let's send a notification
                String locationQuery = Utility.getPreferredLocation(context);

                Uri weatherUri = WeatherContract.WeatherEntry.buildWeatherLocationWithDate(locationQuery, WeatherContract.normalizeDate(System.currentTimeMillis()));
                ...
                if (cursor.moveToFirst()) {
                    ...
                    String weatherDesc = cursor.getString(INDEX_SHORT_DESC);
                    ...
                    //build our notification using NotificationCompat, Builder, pointing to a PendingIntent built

                    //NotificationCompatBuilder is a very convenient way to build backward-compative
                    //notification. Just throw in some data
                    ...
                    //Make something interesting happen when user clicks on the notification.
                    //In this case, opening the app is sufficient.
                    Intent resultIntent = new Intent(context, ForecastFragment.class);
                    ...
                    nm.notify(WEATHER_NOTIFICATION_ID, myBuilder.build());
